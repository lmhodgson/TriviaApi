    ...
    */
    var menuItemBuilder = function menuItemBuilder(nodes, child, index) {
      ...
      var isSelected = Array.isArray(selectedItems) ? selectedItems.some(function (obj) {
        return areEqual(obj.value, value);
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          menuItems.length === 0 && React.createElement(ListItem, { primaryText: noMatchFound, style: { cursor: 'default', padding: '10px 16px' }, disabled: true })
        ),

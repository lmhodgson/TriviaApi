...
exports.objectShape = exports.checkFormat = undefined;
...
function areEqual(val1, val2) {
  ...
  if (!val1 || !val2 || (typeof val1 === 'undefined' ? 'undefined' : _typeof(val1)) !== (typeof val2 === 'undefined' ? 'undefined' : _typeof(val2))) return false;
...
var checkFormat = exports.checkFormat = function checkFormat(value) {
  return value.findIndex(function (v) {
    return (typeof v === 'undefined' ? 'undefined' : _typeof(v)) !== 'object' || !('value' in v);
  });
};

var objectShape = exports.objectShape = _propTypes2.default.shape({
